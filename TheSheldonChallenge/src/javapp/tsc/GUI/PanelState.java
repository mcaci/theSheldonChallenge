...
import javapp.tsc.GUI.panels.RuleInfoPanel;
...
public enum PanelState {
	CREDITS {
		...
		@Override
		public final BasePanel buildPanel(TSCWindow frame) {
	...
	RULES {
		...
		@Override
		public final BasePanel buildPanel(TSCWindow frame) {
			return new RuleInfoPanel(frame);
		}
	},
	NOT_READY {
		@Override
	...
	public abstract BasePanel buildPanel(TSCWindow frame);
}
