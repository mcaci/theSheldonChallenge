...
import resultsStorage.IResultWriter;

/**
 * @author nikiforos
 *
 */
public class MySQLdbResultsWriter implements IResultWriter {
	...
	public void write(GameSession g) throws Exception{
		...
		try {
			...
			statement.executeUpdate("INSERT INTO sakila.outcomes (WINNER, SCOREp1, SCOREp2)" +
					" VALUES ('" + g.getSessionWinner().getID() + "', " + g.getP1().getPunti() + ", " + g.getP2().getPunti() + ")");
